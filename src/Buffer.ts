export default class Buffer {
  ...
  public cxr: number //cx register

  public cx_off: number;
  public cy_off: number;

  public lines: string[]
  // public hl: string[]

  constructor(fn: string, lines: string[]) {
    this.cx_off = 0;
    this.cy_off = 0;
  ...
  draw(ctx: CanvasRenderingContext2D, row: number, col: number, chw: number, chh: number) {
